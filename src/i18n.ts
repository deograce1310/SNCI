  ...
  fr: {
    translation: {
      ...
      hero: {
        ...
        subtitle: 'Des équipes qualifiées et certifiées qui réalisent vos projets avec qualité et dans les délais, selon les normes internationales, onshore et offshore, partout en Afrique de l\'Ouest.',
        badge1: 'Personnel certifié',
        badge2: 'Normes internationales',
        badge3: 'Qualité & délais',
      },
      dev: {
        motto: 'Offrir dans un bref délai et avec qualité des prestations certifiées à tous les clients.',
      },
      metiers: {
        ...
        personnel: 'Mise à disposition de personnels industriels qualifiés et certifiés',
